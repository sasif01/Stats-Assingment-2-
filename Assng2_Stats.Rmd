...
From the different metrics (adjR^2, Cp/AIC, BIC), we get slightly different best-fit models. The model with the lowest Cp/AIC score included 4 predictor (X^1, X^2, X^3, X^10), while the lowest BIC score only included 3 (X^1, X^2, X^3). Additionally, the model with the highest adjusted R-squared included 5 predictors (X^1, X^2, X^3, X^6, X^10). All metrics agree that the first three predictors need be included (X^1, X^2, X^3), whereas some suggest additional variable. BIC, in particular, tends to penalize large models, which explain the use of only the minimum number of predictors. Overall, the best fit models all include at atleast 3 polynomials (X^1, X^2, X^3).
