...
From this model we see that the predictor vairable X, by itself, is always significant. It is always included in the model. From the plots of various metrics of model aqeqancy we see that the best model is one with three predictor vairables. from the summary output we see that this is the model 
...
```{r}
#The n is 100, given that there are 100 observed (y) values. The p is 1 since there is only one predictor variable (x).
