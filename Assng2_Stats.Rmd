...
```{r}
summary(fit.glm.4)
#The p-values show that linear and quadratic values are statistically significant while cubic and 4th degree values are not. This result is consistent with the CV results above. 
```
